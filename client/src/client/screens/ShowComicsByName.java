 ...
 * @author chivu
 */
public class ShowComicsByName extends javax.swing.JDialog {
     ...
     */
    public ShowComicsByName(java.awt.Frame parent, boolean modal, String name) {
        super(parent, modal);
        this.parent = parent;
        initComponents();
        try {
    ...
    private void loadData(String name) {
        String data = sc.query("select * from comic where title='"+name+"';");
        if (!data.equals("")) {
