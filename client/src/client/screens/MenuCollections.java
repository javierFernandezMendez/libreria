 ...
 * @author chivu
 */
public class MenuCollections extends javax.swing.JDialog {
    private java.awt.Frame parent;
    /**
     * Creates new form MenuComics
     */
    public MenuCollections(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.parent = parent;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("menu_collections")); // NOI18N
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        new ShowCollections(this.parent, false).setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new ModifyCollection(this.parent, false).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuCollections.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MenuCollections dialog = new MenuCollections(new javax.swing.JFrame(), true);
